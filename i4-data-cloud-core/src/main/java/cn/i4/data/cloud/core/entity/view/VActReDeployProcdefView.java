 ...
 */
public class VActReDeployProcdefView extends BaseView<VActReDeployProcdefView> {

	private static final long serialVersionUID = 1604047927208L;

	public VActReDeployProcdefView(VActReDeployProcdefModel model) {
		this.procdefId = model.getProcdefId();
		this.deploymentId = model.getDeploymentId();
		this.procdefName = model.getProcdefName();
		this.deploymentCreateTime = model.getDeploymentCreateTime();
		this.procdefKey = model.getProcdefKey();
		this.procdefVersion = model.getProcdefVersion();
		this.resourceName = model.getResourceName();
		this.imgName = model.getImgName();
	}

	public VActReDeployProcdefView() {
