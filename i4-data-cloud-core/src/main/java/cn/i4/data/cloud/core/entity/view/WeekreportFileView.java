 ...
 */
public class WeekreportFileView extends BaseView<WeekreportFileView> {

	private static final long serialVersionUID = 1605856076186L;

	public WeekreportFileView(WeekreportFileModel model) {
		this.id = model.getId();
