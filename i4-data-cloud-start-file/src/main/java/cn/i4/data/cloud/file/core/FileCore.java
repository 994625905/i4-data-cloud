package cn.i4.data.cloud.file.core;

import cn.i4.data.cloud.base.util.StringUtil;
import cn.i4.data.cloud.file.config.FdfsConfig;
...
public class FileCore {
     ...
     * @return
     */
    public FdfsConfig getFdFsConfig(){
        return this.fdfsConfig;
    }
    /**
    ...
    private String getResAccessUrl(StorePath storePath) {
        ...
        return "http://"+fdfsConfig.getResHost()+"/"+fileUrl;
    }
