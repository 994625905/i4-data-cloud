        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <#list menuList as menu>
                                    ...
                                    <div class="layui-row layui-col-space5">
                                        ...
                                        <div class="layui-col-xs10">
                                            ...
                                            <#list menu.child as child>
                                                                ...
                                                                <div class="layui-row">
                                                                    ...
                                                                    <div class="layui-col-xs10">
                                                                        ...
                                                                        <#list child.child as button>
                                                                            <button class="layui-btn layui-btn-sm layui-btn-primary menu" parent-id="${button.parentId?c}" data-id="${button.id?c}">${button.name}</button>
                                                                        </#list>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <#else>
                                                    <button class="layui-btn layui-btn-sm layui-btn-primary menu" parent-id="${child.parentId?c}" data-id="${child.id?c}">${child.name}</button>
                                                </#if>
                                            </#list>
                                        </div>
                                    </div>
                    ...
                    <#else>
                        <button class="layui-btn layui-btn-sm layui-btn-primary menu" parent-id="${menu.parentId?c}" data-id="${menu.id?c}">${menu.name}</button>
                    </#if>
                </#list>
            </div>
        </div>
