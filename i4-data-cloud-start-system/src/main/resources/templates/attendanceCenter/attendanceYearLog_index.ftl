...
<br>
    <div class="layui-fluid">
        <div class="layui-row layui-col-space10">
            ...
            <div class="layui-col-xs12">
                <div id="yearTable" lay-filter="yearTable"></div>
            </div>
        </div>
    </div>
</body>
<script type="text/javascript" src="${StaticServer}/templates/attendanceCenter/attendanceYearLog_index.js?v=1.1"></script>
</@override>
