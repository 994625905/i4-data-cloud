                            ...
                            <div class="layui-input-inline">
                                <select class="layui-input" name="attendanceDayId">
                                    ...
                                    <#if dayList?? && dayList?size &gt; 0>
                                        <#list dayList as day>
                                            <option value="${day.id}" <#if model.attendanceDayId == day.id>selected</#if> >${day.workDate}-<#if day.attendanceStage == 0>上班<#else>下班</#if></option>
                                        </#list>
                                    <#else>
...
<script type="text/javascript" src="${StaticServer}/templates/attendanceCenter/attendanceMend_edit.js?v=1.1"></script>
</@override>
