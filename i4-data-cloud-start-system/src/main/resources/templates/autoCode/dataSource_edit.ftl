            ...
            <form class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <img src="${dataSource.dataSourceCover!}" class="rounded" style="max-width: 200px" id="dataSourceCover">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="datasourceName" value="${dataSource.datasourceName!}" lay-verify="datasourceName" placeholder="请输入数据源名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">数据源链接：</label>
                    <div class="layui-input-block">
                        <input name="datasourceUrl" value="${dataSource.datasourceUrl!}" lay-verify="datasourceUrl" placeholder="请输入数据源链接" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="databaseName" value="${dataSource.databaseName!}" lay-verify="databaseName" placeholder="请输入数据库名称" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="defaultAuthor" value="${dataSource.defaultAuthor!}" placeholder="生成代码的默认作者" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="defaultPackagePrefix" value="${dataSource.defaultPackagePrefix!}" placeholder="核心业务包名" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="defaultLocal" value="${dataSource.defaultLocal!}" placeholder="默认存放的地址" class="layui-input">
                    </div>
