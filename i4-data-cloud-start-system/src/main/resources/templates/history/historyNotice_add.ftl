                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input id="title" name="title" lay-verify="required" placeholder="请输入标题" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">公告类型</label>
                        <div class="layui-input-inline">
                            <select name="typeId" class="layui-input" lay-verify="required">
...
<script type="text/javascript" src="${StaticServer}/templates/history/historyNotice_add.js?v=1.4"></script>
</@override>
