<@override name="body">
<title>爱思数据云平台·点滴/历史相册详情页</title>
<style>
    .image-list{
        position: relative;
        overflow: hidden;
...
<script>
    let groupId = ${param.groupId?c}
    let groupName = "${param.groupName!}"
</script>
<script type="text/javascript" src="${StaticServer}/templates/history/historyImageWall_detail.js?v=1.3"></script>
</@override>
