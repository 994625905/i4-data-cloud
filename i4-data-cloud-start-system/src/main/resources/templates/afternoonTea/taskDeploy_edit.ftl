                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input name="title" value="${model.title}" lay-verify="required" placeholder="请输入名称" class="layui-input">
                        </div>
                    </div>
                    <div class="menuList">
                            ...
                            <div class="layui-form-item menu">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input name="date" value="${menu.date}" id="date${menu_index}" lay-verify="required" class="layui-input">
                                    </div>
                                    <input type="hidden" name="menuId" value="${menu.id?c}">
                                    <div class="layui-form-mid layui-word-aux week" id="week${menu_index}">${menu.week}</div>
                                </div>
                                <#list menu.teaList as tea>
                                    <div class="layui-inline tea border border-light-secondary" style="line-height: 15px">
                                        <div class="flex flex-column align-center justify-center position-relative">
                                            <a class="position-absolute" style="top: -10px;right:-7px" title="删除" id="deleteTea${menu_index}_${tea_index}"><i class="iconfont icon-shanchu text-danger"></i></a>
                                            <img class="rounded" src="${tea.image}" style="max-width: 45px" title="${tea.name}" data-id="${tea.id?c}">
                                            <span class="text-danger font-weight-bold">￥：${tea.price}</span>
                                            <span class="font-xs">${tea.name}</span>
                                        </div>
                                    </div>
                                </#list>
                                <div class="layui-inline" id="teaList${menu_index}" data-size="${menu.teaList?size}">
                                    <div class="layui-input-inline">
                                        <a title="添加下午茶可选项"><i class="iconfont icon-xinzeng text-primary" id="addTea${menu_index}"></i></a>
                                        <a title="删除"><i class="iconfont icon-shanchu1 text-danger ml-1" id="delete${menu_index}"></i></a>
                                    </div>
                                </div>
                            </div>
                        </#list>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="describeInfo"  placeholder="非必填项" class="layui-textarea">${model.describeInfo}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <@permission value="afternoonTea:taskDeploy/update">
...
<script>
    ...
    let menuListLength = ${menuList?size}
</script>
<script type="text/javascript" src="${StaticServer}/templates/afternoonTea/taskDeploy_edit.js?v=1.6"></script>
</@override>
