...
function loadTable(){
    let tabCols = [[
        ...
        {field:"processStatus",title:"审批状态",toolbar:"#enclosureCols",width:TABLE_COL_WIDTH.one_Cols(4)},
...
/** 查看流程图 */
function showProcessImage(title,processId,processStatus){

    Request.async(BasePath+"/leaveRout/leaveApply/get")
    Feng.loadWindow(title+"流程图",BaseUtil+"")
}